...
public class PhoneLoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        callbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onCodeSent(@NonNull String verificationId,
                ...
                loadingBar.dismiss();
                Utility.showLengthToast(PhoneLoginActivity.this,
                        "Code has been send. Please, check your SMS-messages."
                );
    ...
    private void signInWithPhoneAuthCredential(PhoneAuthCredential credential) {
        mAuth.signInWithCredential(credential).addOnCompleteListener(this, task -> {
            if (task.isSuccessful()) {
                loadingBar.dismiss();
                Utility.showShortToast(PhoneLoginActivity.this,
    ...
    private void verifyVerificationCode() {
        ...
        if (TextUtils.isEmpty(verificationCode)) {
            ...
            loadingBar.setCanceledOnTouchOutside(false);
            loadingBar.show();
            PhoneAuthCredential credential = PhoneAuthProvider.getCredential(myVerificationId,
                    verificationCode
            );
    ...
    private void sendUserToAppMainActivity() {
        Intent appMainIntent = new Intent(PhoneLoginActivity.this,
